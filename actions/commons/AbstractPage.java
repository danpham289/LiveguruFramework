...
public abstract class AbstractPage {
	...
	public void selectMultiItemsInCustomDropdown(WebDriver driver, String parentLocator, String childItemLocator,
	...
	public boolean verifyTextInInnerText(WebDriver driver, String textExpected) {
		String textActual = (String) executeJavascriptToBrowser(driver,
	...
	public boolean isImageLoaded(WebDriver driver, String xpathValue) {
		return (Boolean) executeJavascriptToElement(driver,
				"return arguments[0].complete && typeof argument[0].naturalWidth!=\"undefine\" && argument[0].naturalWidth > 0",
				xpathValue);
	}
